---
title: "Research"
pagetitle: "Research — Nick Anderson"
output:
  html_document:
    toc: true
    toc_float: true
    ...
    #code_folding: hide
    includes:
      in_header: ["_head.html", "_meta_research.html"]
...
**Replication:** data and processing scripts are available on the [Data](data.html) page; a self-hosted data download mirror is available at [files.heterodata.org](https://files.heterodata.org/duration-public-finance/).
...
*Note: this figure is reproduced from an external source and is slated for reconstruction directly from Treasury Monthly Statement of the Public Debt (MSPD) and auction data.*
...
A broader interactive treatment of U.S. taxation, spending, deficits, debt, and the Treasury market is at [gerhard.heterodata.org](https://gerhard.heterodata.org).
...
**Replication:** source data is available on the [Data](data.html) page; a self-hosted data download mirror is available at [files.heterodata.org](https://files.heterodata.org/tax-revenue-cyclicality/).
...
3.	**Income Tax Era (1913-1945)**: After the federal income tax enacted in 1894 was struck down by the Supreme Court in *Pollock v. Farmers’ Loan & Trust Co.* (1895), the income tax was reestablished following ratification of the Sixteenth Amendment in February 1913 (the amendment had been proposed under President Taft in 1909); later that year President Wilson signed the Revenue Act of 1913, which reintroduced the federal income tax. The Income Tax does not remain above 50% of federal revenues until World War II. These dates distinguish the third era, in which two wars and a Great Depression occur.
...
A broader interactive treatment of U.S. taxation, spending, deficits, debt, and the Treasury market is at [gerhard.heterodata.org](https://gerhard.heterodata.org). My related empirical work on bank balance sheets and bank failure is collected at [volcker.org](https://volcker.org).
...
**Replication:** the long-run balance-of-payments data is available on the [Data](data.html) page and explorable at [lewis.heterodata.org](https://lewis.heterodata.org); a self-hosted data download mirror is available at [files.heterodata.org](https://files.heterodata.org/).
