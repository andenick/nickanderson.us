...
**Replication:** data and processing scripts are available on the [Data](data.html) page; a self-hosted data download mirror is coming online at [files.heterodata.org](https://files.heterodata.org/duration-public-finance/) (mirror coming online).
...
**Replication:** source data is available on the [Data](data.html) page; a self-hosted data download mirror is coming online at [files.heterodata.org](https://files.heterodata.org/tax-revenue-cyclicality/) (mirror coming online).
...
**Replication:** the long-run balance-of-payments data is available on the [Data](data.html) page and explorable at [lewis.heterodata.org](https://lewis.heterodata.org); a self-hosted data download mirror is coming online at [files.heterodata.org](https://files.heterodata.org/) (mirror coming online).
